...
public class GroupComboBoxRenderer extends JLabel implements ListCellRenderer<Groups.Group> {
    @Serial
    private static final long serialVersionUID = -3903209488093963590L;


    @Override
    public Component getListCellRendererComponent(JList<? extends Groups.Group> list, Groups.Group value, int index, boolean isSelected, boolean cellHasFocus) {
        if (null != value) {
